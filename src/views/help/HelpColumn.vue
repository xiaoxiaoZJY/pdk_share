<template>
	<section>
		<el-button type="primary" @click="handleAdd" class="add_product">添加帮助栏目</el-button>
	    <!--列表-->
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" border>
			...
			<el-table-column prop="name" label="帮助栏目" width="200" >
			</el-table-column>
			<el-table-column prop="addr" label="栏目描述" min-width="400">
			</el-table-column>
			<el-table-column prop="age" label="分类排序" width="140">
			</el-table-column>
