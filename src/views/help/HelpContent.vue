<template>
	<section>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" border>
			...
			<el-table-column prop="name" label="帮助标题" width="200" >
			</el-table-column>
			<el-table-column prop="sex" label="帮助栏目" width="200">
			</el-table-column>
			<el-table-column prop="age" label="创建时间" min-width="140">
			</el-table-column>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="150px" :rules="editFormRules" ref="editForm">
				...
				<el-form-item label="Body:">
					<el-input type="textarea" v-model="editForm.name"></el-input>
				</el-form-item>				
			</el-form>
			<div slot="footer" class="dialog-footer">
