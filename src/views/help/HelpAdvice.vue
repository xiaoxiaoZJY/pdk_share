<template>
	<section>
		<el-button type="primary" @click="handleAdd" class="add_product">添加投诉与建议</el-button>
	    <!--列表-->
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" border>
			...
			<el-table-column prop="age" label="创建时间" width="250" >
			</el-table-column>
			<el-table-column prop="name" label="联系人" width="140">
			</el-table-column>
			<el-table-column prop="age" label="联系电话" width="140">
			</el-table-column>
			<el-table-column prop="sex" label="类型" width="120">
			</el-table-column>
			<el-table-column prop="addr" label="具体内容" min-width="140">
			</el-table-column>
		...
		<el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
			<el-form :model="addForm" label-width="150px" :rules="addFormRules" ref="addForm">
				...
				<el-form-item label="类型:">
					<el-select v-model="value" multiple filterable default-first-option placeholder= "请选择状态">
