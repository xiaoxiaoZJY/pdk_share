<template>
	<section>
		<!-- <el-col :span="4" class="service_addr">
			<el-select v-model="value" multiple filterable default-first-option placeholder= "会员等级">
			    <el-option v-for="item in options5" :key="item.value" :label="item.label" :value="item.value">
			    </el-option>
			</el-select>
		</el-col> 
		<el-col :span="4" class="service_addr">
			<el-select v-model="value2" multiple filterable default-first-option placeholder= "会员类型">
			    <el-option v-for="item in options5" :key="item.value" :label="item.label" :value="item.value">
			    </el-option>
			</el-select>
		</el-col>
		<el-col :span="4" class="service_addr">
			<el-select v-model="value3" multiple filterable default-first-option placeholder= "会员类型">
			    <el-option v-for="item in options5" :key="item.value" :label="item.label" :value="item.value">
			    </el-option>
			</el-select>
		</el-col>
		...
		<el-button type="primary" @click="handleAddpersonal" class="add_product">添加个人会员</el-button>
		<el-button type="primary" @click="handleAddbussiness" class="add_product">添加企业会员</el-button> -->
		...
		<!-- <el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" border>
			...
			<el-table-column prop="name" label="会员名" min-width="140" >
			</el-table-column>
			<el-table-column prop="sex" label="联系电话" width="140">
			</el-table-column>
			<el-table-column prop="age" label="总订单数" width="140">
			</el-table-column>
			<el-table-column prop="age" label="未付款" width="140">
			</el-table-column>
			<el-table-column prop="addr" label="已付款" width="140">
			</el-table-column>
			<el-table-column prop="addr" label="充值金额（元）" width="140">
			</el-table-column>
			<el-table-column prop="addr" label="账户余额（元）" width="140">
			</el-table-column>
			<el-table-column prop="sex" label="会员等级" width="140">
			</el-table-column>
			<el-table-column prop="addr" label="会员类型" width="140">
			</el-table-column>
			<el-table-column prop="sex" label="会员状态" width="140">
			</el-table-column>
